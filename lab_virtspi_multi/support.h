...
/* try to be helpful if someone uses the old IO_CS from the previous lab */
#define IO_CS IO_CS1; do { \
	fprintf(stderr, "Which CS did you mean? (hint: IO_CS in lab_virtspi_single is now IO_CS1)\n"); \
	fprintf(stderr, "\tIO_CS used in file '%s', line %d, function %s()\n", __FILE__, __LINE__, __func__); \
	exit(1); \
	} while(0);
